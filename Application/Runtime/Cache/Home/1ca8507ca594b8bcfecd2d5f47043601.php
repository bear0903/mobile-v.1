...
<div class="websiteWrapper"> 
  ...
  <div class="pageWrapper portfolioTwoPageWrapper"> 
    ...
    <div class="portfolioTwoWrapper"> 
      ...
      <div class="portfolioTwoItemWrapper"> <a href="singleProject.html" class="portfolioTwoItemImageWrapper"><img src="images/small-1-1.jpg" alt=""/></a>
        <div class="portfolioTwoItemInfoWrapper">
          <h4 class="portfolioTwoItemTitle">Dolores eos qui</h4>
        </div>
      </div>
      <!-- portfolio item ends --> 
      <!-- portfolio item starts  -->
      <div class="portfolioTwoItemWrapper"> <a href="singleProject.html" class="portfolioTwoItemImageWrapper"><img src="images/small-1-2.jpg" alt=""/></a>
        <div class="portfolioTwoItemInfoWrapper">
          <h4 class="portfolioTwoItemTitle">Dolores eos qui</h4>
        </div>
      </div>
      <!-- portfolio item ends --> 
      <!-- portfolio item starts  -->
      <div class="portfolioTwoItemWrapper"> <a href="singleProject.html" class="portfolioTwoItemImageWrapper"><img src="images/small-1-3.jpg" alt=""/></a>
        <div class="portfolioTwoItemInfoWrapper">
          <h4 class="portfolioTwoItemTitle">Dolores eos qui</h4>
        </div>
      </div>
      <!-- portfolio item ends --> 
      <!-- portfolio item starts  -->
      <div class="portfolioTwoItemWrapper"> <a href="singleProject.html" class="portfolioTwoItemImageWrapper"><img src="images/small-1-4.jpg" alt=""/></a>
        <div class="portfolioTwoItemInfoWrapper">
          <h4 class="portfolioTwoItemTitle">Dolores eos qui</h4>
        </div>
      </div>
      <!-- portfolio item ends --> 
      <!-- portfolio item starts  -->
      <div class="portfolioTwoItemWrapper"> <a href="singleProject.html" class="portfolioTwoItemImageWrapper"><img src="images/small-1-5.jpg" alt=""/></a>
        <div class="portfolioTwoItemInfoWrapper">
          <h4 class="portfolioTwoItemTitle">Dolores eos qui</h4>
        </div>
      </div>
      <!-- portfolio item ends --> 
      <!-- portfolio item starts  -->
      <div class="portfolioTwoItemWrapper"> <a href="singleProject.html" class="portfolioTwoItemImageWrapper"><img src="images/small-1-6.jpg" alt=""/></a>
        <div class="portfolioTwoItemInfoWrapper">
          <h4 class="portfolioTwoItemTitle">Dolores eos qui</h4>
        </div>
      </div>
