...
<script type="text/javascript" src="/think/Application/js/jquery-1.11.1.js"></script>
<script type="text/javascript" src="/think/Application/js/jquery.js"></script>
<!-- <script type="text/javascript" src="/think/Application/js/select.js"></script> -->
<link href="/think/Public/css/style-select.css" rel="stylesheet" type="text/css"/>
<style><!--
body{ 
position:absolute;
margin:0;
...
.one{ width:258px; height:40px; border:none; font-size:14px; color:#aaaaaa; display:block; margin:0; font-family:"微软雅黑";line-height: 39px;margin-left: 22px;}
.two{ width:258px; height:40px; border:none; font-size:14px; color:#aaaaaa; display:block; margin:0; font-family:"微软雅黑";line-height: 39px;margin-left: 22px;}
.three{ width:264px; height:42px; border:none; font-size:14px; color:#aaaaaa; display:block; margin:0; font-family:"微软雅黑";line-height: 39px;margin-left: 18px;color: black;}
.four{ width:264px; height:42px; border:none; font-size:14px; color:#aaaaaa; display:block; margin:0; font-family:"微软雅黑";line-height: 39px;margin-left: 18px;appearance: none;color: black;}

.one,.two,.three,.four,.y4,.y5,.y6,.textarea:focus{outline: none;}

.y4{width:256px; height:40px; border:none; font-size:14px; color:black; display:block; margin:0;;font-family:"微软雅黑";line-height: 40px;margin-left: 22px;}
.y5{width:256px; height:40px; border:none; font-size:14px; color:black; display:block; margin:0;;font-family:"微软雅黑";line-height: 40px;margin-left: 22px;}
.y6{width:256px; height:40px; border:none; font-size:14px; color:#aaaaaa; display:block; margin:0;;font-family:"微软雅黑";line-height: 40px;margin-left: 22px;}
...
.three,.four,.y1,.y2,.y3{
background: url(Public/img/dao6.png) no-repeat right;
}

.k1,.k2 {
background: url(Public/img/png3.png) no-repeat 3px 13px; 
}

.k3,.k4 {
background: url(Public/img/png4.png) no-repeat 3px 13px;
}
  ...
  <div class="login-div" id="login-div">
     ...
     <div class="loginbox" id="loginbox">
       <div class="loginboxtop">
		...
		<div id="k3" class="k3">
		<select name="lang" id="lang" class="three" onclick="f1()" onfocus="f1()" selWidth="258">
		...
		<select name="companyno" id="companyno" class="four" selWidth="258">
		<!-- <option value="0">请选择</option> -->
       ...
       <input id="username" name="username" class="one" type="text" value="请输入账号" onclick="if(this.value==defaultValue) {this.value='';this.className='y4';this.type='text';}else{this.className='y4';} " onblur="if(!value) {value=defaultValue;this.className='y6';this.type='text';}else{this.className='y5';} " 
       																						onfocus="if(this.value==defaultValue) {this.value='';this.className='y4';this.type='text';}else{this.className='y4';} ">
       </div>
       <div id="k2" class="k2">
       ...
       <input class="button-submit" type="submit" id="lgoin" name="logon" value="登录" ">
