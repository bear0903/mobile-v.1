  ...
  <div class="pageWrapper portfolioOneFilterablePageWrapper"> 
    ...
    <div class="portfolioOneFilterableWrapper">
      <div class="portfolioFilterableItemsWrapper" id="portfolioFilterableItemsWrapper"> 
        ...
        <div class="portfolioFilterableItemWrapper" data-type="websites,logos"> <a href="singleProject.html" class="portfolioFilterableItemImageWrapper"><img src="images/small-1-1.jpg" alt=""/></a>
          <div class="portfolioFilterableItemInfoWrapper">
            <h4 class="portfolioFilterableItemTitle">Dolores eos qui</h4>
            <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium.</p>
          </div>
          <div class="portfolioFilterableItemButtonsWrapper"><a href="images/large-1.jpg" class="portfolioFilterableExpandButton">expand</a><a href="singleProject.html" class="portfolioFilterableDetailsButton">details</a></div>
        </div>
        <!-- portfolio item ends --> 
        <!-- portfolio item starts  -->
        <div class="portfolioFilterableItemWrapper" data-type="logos"> <a href="singleProject.html" class="portfolioFilterableItemImageWrapper"><img src="images/small-1-2.jpg" alt=""/></a>
          <div class="portfolioFilterableItemInfoWrapper">
            <h4 class="portfolioFilterableItemTitle">Dolores eos qui</h4>
            <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium.</p>
          </div>
          <div class="portfolioFilterableItemButtonsWrapper"><a href="images/large-2.jpg" class="portfolioFilterableExpandButton">expand</a><a href="singleProject.html" class="portfolioFilterableDetailsButton">details</a></div>
        </div>
        <!-- portfolio item ends --> 
        <!-- portfolio item starts  -->
        <div class="portfolioFilterableItemWrapper" data-type="photos"> <a href="singleProject.html" class="portfolioFilterableItemImageWrapper"><img src="images/small-1-3.jpg" alt=""/></a>
          <div class="portfolioFilterableItemInfoWrapper">
            <h4 class="portfolioFilterableItemTitle">Dolores eos qui</h4>
            <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium.</p>
          </div>
          <div class="portfolioFilterableItemButtonsWrapper"><a href="images/large-3.jpg" class="portfolioFilterableExpandButton">expand</a><a href="singleProject.html" class="portfolioFilterableDetailsButton">details</a></div>
        </div>
        <!-- portfolio item ends --> 
      </div>
    </div>
