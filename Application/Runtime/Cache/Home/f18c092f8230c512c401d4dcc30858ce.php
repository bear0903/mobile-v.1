...
<div class="websiteWrapper"> 
  ...
  <div class="pageWrapper portfolioOnePageWrapper"> 
    ...
    <div class="portfolioOneWrapper"> 
      ...
      <div class="portfolioOneItemWrapper"> <a href="singleProject.html" class="portfolioOneItemImageWrapper"><img src="images/small-1-1.jpg" alt=""/></a>
        <div class="portfolioOneItemInfoWrapper">
          <h4 class="portfolioOneItemTitle">Dolores eos qui</h4>
          <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium.</p>
        </div>
        <div class="portfolioOneItemButtonsWrapper"><a href="images/large-1.jpg" class="portfolioOneExpandButton">expand</a><a href="singleProject.html" class="portfolioOneDetailsButton">details</a></div>
      </div>
      <!-- portfolio item ends --> 
      <!-- portfolio item starts  -->
      <div class="portfolioOneItemWrapper"> <a href="singleProject.html" class="portfolioOneItemImageWrapper"><img src="images/small-1-2.jpg" alt=""/></a>
        <div class="portfolioOneItemInfoWrapper">
          <h4 class="portfolioOneItemTitle">Dolores eos qui</h4>
          <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium.</p>
        </div>
        <div class="portfolioOneItemButtonsWrapper"><a href="images/large-2.jpg" class="portfolioOneExpandButton">expand</a><a href="singleProject.html" class="portfolioOneDetailsButton">details</a></div>
      </div>
      <!-- portfolio item ends --> 
      <!-- portfolio item starts  -->
      <div class="portfolioOneItemWrapper"> <a href="singleProject.html" class="portfolioOneItemImageWrapper"><img src="images/small-1-3.jpg" alt=""/></a>
        <div class="portfolioOneItemInfoWrapper">
          <h4 class="portfolioOneItemTitle">Dolores eos qui</h4>
          <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium.</p>
        </div>
        <div class="portfolioOneItemButtonsWrapper"><a href="images/large-3.jpg" class="portfolioOneExpandButton">expand</a><a href="singleProject.html" class="portfolioOneDetailsButton">details</a></div>
      </div>
      <!-- portfolio item ends --> 
    </div>
